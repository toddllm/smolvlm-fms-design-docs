...
- **[Vision families: Docling vs Mistral](foundation-model-stack/fms/models/vision_families_docling_vs_mistral.md)** – Compares Docling (Idefics-3 lineage) and Mistral vision tracks, summarizing shared architectures and key differences in preprocessing, token compaction, token count derivation, placeholder semantics, and architecture transparency.  
